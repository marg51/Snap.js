...
var n=n||function(n){var a={element:null,dragger:null,disable:"none",addBodyClasses:!1,hyperextensible:!0,resistance:.5,flickThreshold:50,transitionSpeed:.3,easing:"ease",maxPosition:266,minPosition:-266,tapToClose:!0,touchToDrag:!0,slideIntent:40,minDragDistance:5},s={simpleStates:{opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},r={},i={hasTouch:"ontouchstart"in t.documentElement||e.navigator.msPointerEnabled,eventType:function(e){var t={down:i.hasTouch?"touchstart":"mousedown",move:i.hasTouch?"touchmove":"mousemove",up:i.hasTouch?"touchend":"mouseup",out:i.hasTouch?"touchcancel":"mouseout"}
return t[e]},page:function(e,t){return i.hasTouch&&t.touches.length&&t.touches[0]?t.touches[0]["page"+e]:t["page"+e]},klass:{has:function(e,t){return-1!==e.className.indexOf(t)},add:function(e,t){!i.klass.has(e,t)&&a.addBodyClasses&&(e.className+=" "+t)},remove:function(e,t){a.addBodyClasses&&(e.className=e.className.replace(t,"").replace(/^\s+|\s+$/g,""))}},dispatchEvent:function(e){return"function"==typeof r[e]?r[e].call():void 0},hasEvent:function(e){return"function"==typeof r[e]?!0:!1},vendor:function(){var e,n=t.createElement("div"),a="webkit Moz O ms".split(" ")
for(e in a)if(void 0!==n.style[a[e]+"Transition"])return a[e]},transitionCallback:function(){return"Moz"===s.vendor||"ms"===s.vendor?"transitionend":s.vendor+"TransitionEnd"},canTransform:function(){return void 0!==a.element.style[s.vendor+"Transform"]},deepExtend:function(e,t){var n
for(n in t)t[n]&&t[n].constructor&&t[n].constructor===Object?(e[n]=e[n]||{},i.deepExtend(e[n],t[n])):e[n]=t[n]
return e},angleOfDrag:function(e,t){var n,a
return a=Math.atan2(-(s.startDragY-t),s.startDragX-e),0>a&&(a+=2*Math.PI),n=Math.floor(a*(180/Math.PI)-180),0>n&&n>-180&&(n=360-Math.abs(n)),Math.abs(n)},events:{addEvent:function(e,t,n){return e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent?e.attachEvent("on"+t,n):void 0},removeEvent:function(e,t,n){return e.addEventListener?e.removeEventListener(t,n,!1):e.attachEvent?e.detachEvent("on"+t,n):void 0},prevent:function(e){e.preventDefault?e.preventDefault():e.returnValue=!1}},parentUntil:function(e,t){for(var n="string"==typeof t;e.parentNode;){if(n&&e.getAttribute&&e.getAttribute(t))return e
if(!n&&e===t)return e
e=e.parentNode}return null}},o={translate:{get:{matrix:function(t){if(i.canTransform()){var n=e.getComputedStyle(a.element)[s.vendor+"Transform"].match(/\((.*)\)/),r=8
return n?(n=n[1].split(","),16===n.length&&(t+=r),parseInt(n[t],10)):0}return parseInt(a.element.style.left,10)}},easeCallback:function(){a.element.style[s.vendor+"Transition"]="",s.translation=o.translate.get.matrix(4),s.easing=!1,s.animatingInterval&&clearInterval(s.animatingInterval),0===s.easingTo&&(i.klass.remove(t.body,"snapjs-right"),i.klass.remove(t.body,"snapjs-left")),i.dispatchEvent("animated"),i.events.removeEvent(a.element,i.transitionCallback(),o.translate.easeCallback)},easeTo:function(e){i.canTransform()?(s.easing=!0,s.easingTo=e,a.element.style[s.vendor+"Transition"]="all "+a.transitionSpeed+"s "+a.easing,i.hasEvent("animating")&&(s.animatingInterval=setInterval(function(){i.dispatchEvent("animating")},5)),i.events.addEvent(a.element,i.transitionCallback(),o.translate.easeCallback),o.translate.x(e)):(s.translation=e,o.translate.x(e)),0===e&&(a.element.style[s.vendor+"Transform"]="")},x:function(n){if(!("left"===a.disable&&n>0||"right"===a.disable&&0>n))if(a.hyperextensible||(n===a.maxPosition||n>a.maxPosition?n=a.maxPosition:(n===a.minPosition||n<a.minPosition)&&(n=a.minPosition)),n=parseInt(n,10),isNaN(n)&&(n=0),i.canTransform()){var r="translate3d("+n+"px, 0,0)"
...
if(n)return i.dispatchEvent("ignore"),void 0
if(a.dragger){var r=i.parentUntil(t,a.dragger)
if(!r&&s.translation!==a.minPosition&&s.translation!==a.maxPosition)return}i.dispatchEvent("start"),a.element.style[s.vendor+"Transition"]="",s.isDragging=!0,s.hasIntent=null,s.intentChecked=!1,s.startDragX=i.page("X",e),s.startDragY=i.page("Y",e),s.dragWatchers={current:0,last:0,hold:0,state:""},s.simpleStates={opening:null,towards:null,hyperExtending:null,halfway:null,flick:null,translation:{absolute:0,relative:0,sinceDirectionChange:0,percentage:0}}},dragging:function(e){if(s.isDragging&&a.touchToDrag){var n,r=i.page("X",e),l=i.page("Y",e),d=s.translation,c=o.translate.get.matrix(4),g=r-s.startDragX,h=c>0,p=g
if(s.intentChecked&&!s.hasIntent)return
if(a.addBodyClasses&&(c>0?(i.klass.add(t.body,"snapjs-left"),i.klass.remove(t.body,"snapjs-right")):0>c&&(i.klass.add(t.body,"snapjs-right"),i.klass.remove(t.body,"snapjs-left"))),s.hasIntent===!1||null===s.hasIntent){var m=i.angleOfDrag(r,l),u=m>=0&&m<=a.slideIntent||360>=m&&m>360-a.slideIntent,f=m>=180&&m<=180+a.slideIntent||180>=m&&m>=180-a.slideIntent
s.hasIntent=f||u?!0:!1,s.intentChecked=!0}if(a.minDragDistance>=Math.abs(r-s.startDragX)||s.hasIntent===!1)return
